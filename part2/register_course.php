                                ...
                                <div class="col-lg-6">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ' . (($already_registered) ? ('<button onclick="return confirm(\'Are you sure to drop the course?\');" type="submit" class="btn btn-danger btn-block">Drop</button>') : ('<button onclick="return confirm(\'Are you sure to register the course?\');" type="submit" class="btn btn-primary btn-block">Register</button>')) . '
                                            </form>
                                        </div>
                                    </div>
                                </div>';
